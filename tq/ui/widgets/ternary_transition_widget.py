...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QFrame, QGridLayout, QGroupBox, QSpacerItem,
...
class TernaryTransitionWidget(QWidget):
    ...
    transition_calculated = pyqtSignal(int, int, int)  # first_decimal, second_decimal, result_decimal
    ...
    def _init_ui(self):
        ...
        self.first_ternary_display.setStyleSheet("font-family: monospace; font-weight: bold;")
        ...
        self.second_ternary_display.setStyleSheet("font-family: monospace; font-weight: bold;")
        ...
        self.result_grid_button.setToolTip("Open the result in TQ Grid for detailed analysis")
        self.result_grid_button.clicked.connect(lambda: self._open_in_tq_grid(self.result_decimal_display.text()))
        result_actions.addWidget(self.result_grid_button)
        
        self.result_lookup_button = QPushButton("Look up in Database")
        self.result_lookup_button.setToolTip("Search for this number in the TQ database")
        self.result_lookup_button.clicked.connect(lambda: self._lookup_in_database(self.result_decimal_display.text()))
        ...
        self.result_ternary_display.setStyleSheet("font-family: monospace; font-size: 16px; font-weight: bold;")
        ...
        self.amalgam_decimal_display.setStyleSheet("font-size: 16px; font-weight: bold;")
        ...
        self.amalgam_grid_button.setToolTip("Open the Amalgam result in TQ Grid for detailed analysis")
        self.amalgam_grid_button.clicked.connect(lambda: self._open_in_tq_grid(self.amalgam_decimal_display.text()))
        amalgam_actions.addWidget(self.amalgam_grid_button)
        
        self.amalgam_lookup_button = QPushButton("Look up in Database")
        self.amalgam_lookup_button.setToolTip("Search for this Amalgam number in the TQ database")
        self.amalgam_lookup_button.clicked.connect(lambda: self._lookup_in_database(self.amalgam_decimal_display.text()))
        ...
        self.amalgam_ternary_display.setStyleSheet("font-family: monospace; font-size: 16px; font-weight: bold;")
    ...
    def _calculate_transition(self):
        ...
        try:
            ...
            # Apply transition
            result_ternary = self.transition.apply_transition(first_ternary, second_ternary)
            ...
            # Apply transition
            amalgam_ternary = self.transition.apply_transition(sum_ternary, diff_ternary)
            ...
            self.transition_calculated.emit(first_decimal, second_decimal, result_decimal)

...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QGridLayout, QScrollArea, QTextEdit, QFrame
)
from PyQt6.QtCore import Qt, pyqtSlot
from PyQt6.QtGui import QFont, QColor

from tq.services.ternary_utils import decimal_to_ternary, ternary_to_decimal
...
class CosmicForceWidget(QWidget):
    ...
    def display_results(self, decimal_number, ternary_digits, interpretation):
        ...
        self.ternary_display.setText(f"Decimal {decimal_number} = Ternary {ternary_str}")
        ...
        for i, digit_info in enumerate(interpretation["digits"]):
            ...
            # Meaning label
            meaning_label = QLabel(f"{digit_info['name']} - {digit_info['description']}")

...
class NumberDatabaseWindow(QMainWindow):
    ...
    def _create_quadset_tab(self):
        ...
        self.other_quadsets_label = QLabel("Checking if this number is part of other quadsets...")
    ...
    def _create_references_tab(self):
        ...
        self.references_table.setHorizontalHeaderLabels(["Text", "Method", "Tags", "Date"])
        self.references_table.horizontalHeader().setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)
        self.references_table.horizontalHeader().setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)
        self.references_table.horizontalHeader().setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)
        self.references_table.horizontalHeader().setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)
    ...
    def _update_properties_tab(self, results: Dict[str, Any]):
        ...
        factors_value = QLabel(", ".join(str(f) for f in factors) if factors else "None")
        ...
        divisors_value = QLabel(", ".join(str(d) for d in divisors) if divisors else "None")
        ...
        if is_triangular:
            ...
            self.special_properties_layout.addWidget(QLabel("Triangular Index:"), row, 0)
            self.special_properties_layout.addWidget(QLabel(str(triangular_index)), row, 1)
            row += 1
        ...
        if is_fibonacci:
            ...
            self.special_properties_layout.addWidget(QLabel(str(fibonacci_index)), row, 1)
            row += 1
    ...
    def _update_quadset_tab(self, results: Dict[str, Any]):
        ...
        if is_in_quadset and "base_number" in is_in_quadset_info:
            ...
            self.other_quadsets_label.mousePressEvent = lambda e: self._open_other_quadset(base_number)
        else:
            self.other_quadsets_label.setText(
    ...
    def _display_modern_quadset(self, quadset: Dict[str, Any]):
        ...
        self.quadset_layout.addWidget(QLabel(str(conrune_info.get("number", ""))), row, 1)
        self.quadset_layout.addWidget(QLabel("Ternary:"), row, 2)
        self.quadset_layout.addWidget(QLabel(str(conrune_info.get("ternary", ""))), row, 3)
        row += 1
        
        # Ternary reversal
        reversal_info = quadset.get("ternary_reversal", {})
        self.quadset_layout.addWidget(QLabel("Ternary Reversal:"), row, 0)
        self.quadset_layout.addWidget(QLabel(str(reversal_info.get("number", ""))), row, 1)
        self.quadset_layout.addWidget(QLabel("Ternary:"), row, 2)
        self.quadset_layout.addWidget(QLabel(str(reversal_info.get("ternary", ""))), row, 3)
        row += 1
        
        # Reversal conrune
        reversal_conrune_info = quadset.get("reversal_conrune", {})
        self.quadset_layout.addWidget(QLabel("Reversal Conrune:"), row, 0)
        self.quadset_layout.addWidget(QLabel(str(reversal_conrune_info.get("number", ""))), row, 1)
        self.quadset_layout.addWidget(QLabel("Ternary:"), row, 2)
        self.quadset_layout.addWidget(QLabel(str(reversal_conrune_info.get("ternary", ""))), row, 3)
        row += 1
    ...
    def _display_legacy_quadset(self, quadset: Dict[str, Any]):
        ...
        self.quadset_layout.addWidget(QLabel(str(quadset.get("reverse_ternary_decimal", ""))), row, 1)
        self.quadset_layout.addWidget(QLabel("Ternary:"), row, 2)
        self.quadset_layout.addWidget(QLabel(str(quadset.get("reverse_ternary", ""))), row, 3)
        row += 1
        
        # Reverse conrune
        self.quadset_layout.addWidget(QLabel("Reverse Conrune:"), row, 0)
        self.quadset_layout.addWidget(QLabel(str(quadset.get("reverse_conrune", ""))), row, 1)

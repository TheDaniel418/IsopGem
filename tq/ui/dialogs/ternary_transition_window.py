...
class TernaryTransitionWindow(QMainWindow):
    ...
    def set_transition_numbers(self, first_number: int, second_number: int):
        ...
        """
        logger.debug(f"Setting transition numbers: first={first_number}, second={second_number}")
        ...
        logger.debug(f"Input values set. First input text: {self.widget.first_number_input.text()}, Second input text: {self.widget.second_number_input.text()}")
        ...
        logger.debug(f"Ternary displays updated. First: {self.widget.first_ternary_display.text()}, Second: {self.widget.second_ternary_display.text()}")

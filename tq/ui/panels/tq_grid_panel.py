...
from PyQt6.QtWidgets import (
    ...
    QFrame, QSpacerItem, QSplitter
)
from PyQt6.QtGui import QPixmap, QPainter, QColor, QIntValidator, QFont
from PyQt6.QtCore import Qt, QSize

from tq.utils.ternary_converter import decimal_to_ternary, ternary_to_decimal, format_ternary
...
class TQGridPanel(QFrame):
    ...
    def __init__(self, parent=None, standalone=False):
        ...
        self.number_input.setValidator(QIntValidator(0, 999999))  # Limit to positive integers
    ...
    def _process_number(self) -> None:
        ...
        try:
            ...
            self.reverse_conrune_display.decimal_label.setText(str(reversed_conrune_decimal))
            ...
            self.reverse_conrune_display.visualizer.setMinimumHeight(min_visualizer_height)
            ...
            if self.standalone or self.parent() is None:
                ...
                total_height = header_height + (min_visualizer_height * 2) + 150  # Add some spacing between rows

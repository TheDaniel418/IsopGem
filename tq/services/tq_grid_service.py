...
class TQGridService:
    ...
    def update_grid_display(self, base: int, conrune: int, reversal: int, reversal_conrune: int) -> TQGrid:
        """
        ...
        logger.debug(f"Updated grid display - Base: {base}, Conrune: {conrune}, "

...
class Style:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Style":
        ...
        style.stroke_style = Qt.PenStyle(
            data.get("stroke_style", int(Qt.PenStyle.SolidLine))
        )
        style.fill_style = Qt.BrushStyle(
            data.get("fill_style", int(Qt.BrushStyle.SolidPattern))
        )

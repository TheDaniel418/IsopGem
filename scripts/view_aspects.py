...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="View astrological aspects stored in the database"
    )

    # Date filtering
    parser.add_argument(
        "--date", type=str, help="View aspects for a specific date (YYYY-MM-DD)"
    )
    parser.add_argument(
        "--start-date", type=str, help="Start date for aspect range (YYYY-MM-DD)"
    )
    parser.add_argument(
        "--end-date", type=str, help="End date for aspect range (YYYY-MM-DD)"
    )
    parser.add_argument(
        "--month", type=str, help="View aspects for a specific month (YYYY-MM)"
    )
    parser.add_argument(
        "--year", type=int, help="View aspects for a specific year (YYYY)"
    )

    # Planet filtering
    parser.add_argument("--planet1", type=str, help="Filter by first planet")
    parser.add_argument("--planet2", type=str, help="Filter by second planet")
    ...
    parser.add_argument(
        "--major-only", action="store_true", help="Show only major aspects"
    )

    # Output options
    parser.add_argument(
        "--count", action="store_true", help="Show only the count of matching aspects"
    )
    parser.add_argument(
        "--limit",
        type=int,

...
class WordAbacusWindow(QMainWindow):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        # Connect signals
        self.word_abacus_panel.calculation_performed.connect(self._on_calculation_performed)
    ...
    def _on_calculation_performed(self, result: CalculationResult) -> None:
        ...
        self.setWindowTitle(f"Gematria Word Abacus - {result.input_text} = {result.result_value}")
        logger.debug(f"Calculation performed: {result.input_text} = {result.result_value}")

...
class CalculationDetailsDialog(QDialog):
    ...
    def __init__(self, calculation: CalculationResult, parent=None):
    ...
    def _init_ui(self):
        ...
        method_text.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        timestamp_text = QLabel(self.calculation.timestamp.strftime("%Y-%m-%d %H:%M:%S"))
        timestamp_text.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        self.favorite_button = QPushButton("★ Favorite" if self.calculation.favorite else "☆ Add to Favorites")
    ...
    def _get_method_name(self) -> str:
        ...
        """
        if hasattr(self.calculation, "custom_method_name") and self.calculation.custom_method_name:
    ...
    def _display_tags(self):
        ...
        if self.tags:
            for tag in self.tags:
                ...
                color_widget.setStyleSheet(f"background-color: {tag.color}; border-radius: 8px;")
    ...
    def _on_toggle_favorite(self):
        ...
        if success:
            ...
            self.favorite_button.setText("★ Favorite" if new_favorite else "☆ Add to Favorites")
            if new_favorite:
                self.favorite_button.setStyleSheet("color: gold;")
            else:

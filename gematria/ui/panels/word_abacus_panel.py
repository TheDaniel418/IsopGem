...
from PyQt6.QtWidgets import QVBoxLayout, QWidget, QScrollArea, QPushButton, QHBoxLayout, QDialog, QLabel
...
class WordAbacusPanel(QWidget):
    ...
    def _show_custom_cipher_dialog(self) -> None:
        ...
        if self._custom_cipher_dialog is None:
            ...
            if self._custom_cipher_dialog and hasattr(self.word_abacus_widget, '_on_custom_cipher_updated'):
    ...
    def closeEvent(self, event):
        ...
        if self._custom_cipher_dialog is not None and self._custom_cipher_dialog.isVisible():

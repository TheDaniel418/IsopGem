...
class TagRepository:
    ...
    def create_default_tags(self) -> List[Tag]:
        ...
        default_tags: List[Tag] = [
            Tag(name="Important", color="#FF0000", description="Important findings to review"),
            Tag(name="Biblical", color="#0000FF", description="References to biblical texts"),
            Tag(name="Research", color="#00AA00", description="Items requiring further research"),
            Tag(name="Correspondence", color="#AA00AA", description="Correspondence with other concepts"),
            Tag(name="Follow Up", color="#FFA500", description="Items to follow up on later"),
            Tag(name="Egypt", color="#8B4513", description="Related to Egyptian studies")
        ]

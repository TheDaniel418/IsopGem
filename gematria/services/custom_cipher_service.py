...
class CustomCipherService:
    ...
    def get_ciphers(self, language: Optional[Union[LanguageType, str]] = None) -> List[CustomCipherConfig]:
        ...
        lang_enum = language if isinstance(language, LanguageType) else LanguageType(language)
    ...
    def create_default_templates(self) -> List[str]:
        ...
        hebrew_template = CustomCipherConfig("Hebrew Template", LanguageType.HEBREW, 
        ...
        greek_template = CustomCipherConfig("Greek Template", LanguageType.GREEK,
                                          "Template with Greek standard values")
        ...
        english_template = CustomCipherConfig("English Template", LanguageType.ENGLISH,

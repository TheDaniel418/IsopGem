...
class LocationService:
    ...
    def add_favorite(self, location: Location) -> None:
        ...
        for fav in self._favorites:
            if fav.name == location.name and fav.latitude == location.latitude and fav.longitude == location.longitude:
                return
    ...
    def remove_favorite(self, location: Location) -> None:
        ...
        self._favorites = [
            ...
            if not (fav.name == location.name and fav.latitude == location.latitude and fav.longitude == location.longitude)
        ]

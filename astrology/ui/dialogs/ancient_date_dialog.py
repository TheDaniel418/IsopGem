...
from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QDialogButtonBox, QLabel
...
class AncientDateDialog(QDialog):
    ...
    def __init__(self, parent=None, initial_date=None, title="Select Date"):
        ...
        # Instructions label
        instructions = QLabel("Select a date (supports dates before 1753, including BCE):")

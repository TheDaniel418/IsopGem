...
from PyQt6.QtWidgets import (
    QWidget, QSpinBox, QComboBox, QHBoxLayout, QVBoxLayout,
    QLabel, QCheckBox, QGridLayout, QGroupBox
)
...
class AncientDateSelector(QWidget):
    ...
    def _init_ui(self):
        ...
        self.year_spinbox.setRange(-10000, 9999)  # Support dates from 10,000 BCE to 9999 CE
        ...
        for i, month in enumerate(["January", "February", "March", "April", 
            ...
            self.month_combo.addItem(month, i + 1)  # Store 1-based month number as item data
    ...
    def _is_leap_year(self, year):
        ...
        effective_year = year
        if year <= 0:
            effective_year = abs(year) + 1  # Astronomical year numbering: 1 BCE = year 0, 2 BCE = year -1
    ...
    def date(self):
        ...
        if not date.isValid():
            ...
            date = QDate(year_for_qdate, month, self._days_in_month(year_for_qdate, month))

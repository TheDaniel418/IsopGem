...
from PyQt6.QtCore import QObject, pyqtSignal, QFileInfo, QIODevice, QFile, QTextStream, Qt, QBuffer, QByteArray
from PyQt6.QtGui import QTextDocumentWriter, QTextDocument, QTextCursor
        ...
        if file_path:
            try:
                ...
                QMessageBox.critical(
                    self.editor_window, "Error", f"Could not open the document: {str(e)}"
                )
                return False
        return False
